 ...
 * @subpackage Custom_Google_Analytics/includes
 */
...
class Custom_Google_Analytics {
	...
	public function __construct() {
		if ( defined( 'CUSTOM_GOOGLE_ANALYTICS_VERSION' ) ) {
			$this->version = CUSTOM_GOOGLE_ANALYTICS_VERSION;
		} else {
			$this->version = '1.0.0';
		}
		$this->plugin_name = 'custom-google-analytics';
	 ...
	 *
	 * - Custom_Google_Analytics_Loader. Orchestrates the hooks of the plugin.
	 * - Custom_Google_Analytics_Admin. Defines all hooks for the admin area.
	 * - Custom_Google_Analytics_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-custom-google-analytics-loader.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-custom-google-analytics-admin.php';

		/**
		 * The class responsible for defining all actions that occur in the public-facing
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-custom-google-analytics-public.php';
